# 0 "all.c"
# 1 "/home/ubuntu/SOC-final-project/testbench/all//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "all.c"
# 19 "all.c"
...
# 76 "all.c"
 ...
 (*(volatile uint32_t*)0x38000100) = 0;
 (*(volatile uint32_t*)0x38000104) = -10;
 (*(volatile uint32_t*)0x38000108) = -9;
 (*(volatile uint32_t*)0x3800010c) = 23;
 (*(volatile uint32_t*)0x38000110) = 56;
 (*(volatile uint32_t*)0x38000114) = 63;
 (*(volatile uint32_t*)0x38000118) = 56;
 (*(volatile uint32_t*)0x3800011c) = 23;
 (*(volatile uint32_t*)0x38000120) = -9;
 (*(volatile uint32_t*)0x38000124) = -10;
 (*(volatile uint32_t*)0x38000128) = 0;
 (*(volatile uint32_t*)0x38000130) = 0;
 (*(volatile uint32_t*)0x38000134) = 1;
 (*(volatile uint32_t*)0x38000138) = 2;
 (*(volatile uint32_t*)0x3800013c) = 3;
 (*(volatile uint32_t*)0x38000140) = 4;
 (*(volatile uint32_t*)0x38000144) = 5;
 (*(volatile uint32_t*)0x38000148) = 6;
 (*(volatile uint32_t*)0x3800014c) = 7;
 (*(volatile uint32_t*)0x38000150) = 8;
 (*(volatile uint32_t*)0x38000154) = 9;
 (*(volatile uint32_t*)0x38000158) = 10;
 (*(volatile uint32_t*)0x3800015c) = 11;
 (*(volatile uint32_t*)0x38000160) = 12;
 (*(volatile uint32_t*)0x38000164) = 13;
 (*(volatile uint32_t*)0x38000168) = 14;
 (*(volatile uint32_t*)0x3800016c) = 15;
 (*(volatile uint32_t*)0x38000170) = 16;
 (*(volatile uint32_t*)0x38000174) = 17;
 (*(volatile uint32_t*)0x38000178) = 18;
 (*(volatile uint32_t*)0x3800017c) = 19;
 (*(volatile uint32_t*)0x38000180) = 20;
 (*(volatile uint32_t*)0x38000184) = 21;
 (*(volatile uint32_t*)0x38000188) = 22;
 (*(volatile uint32_t*)0x3800018c) = 23;
 (*(volatile uint32_t*)0x38000190) = 24;
 (*(volatile uint32_t*)0x38000194) = 25;
 (*(volatile uint32_t*)0x38000198) = 26;
 (*(volatile uint32_t*)0x3800019c) = 27;
 (*(volatile uint32_t*)0x380001a0) = 28;
 (*(volatile uint32_t*)0x380001a4) = 29;
 (*(volatile uint32_t*)0x380001a8) = 30;
 (*(volatile uint32_t*)0x380001ac) = 31;
 (*(volatile uint32_t*)0x380001b0) = 32;
 (*(volatile uint32_t*)0x380001b4) = 33;
 (*(volatile uint32_t*)0x380001b8) = 34;
 (*(volatile uint32_t*)0x380001bc) = 35;
 (*(volatile uint32_t*)0x380001c0) = 36;
 (*(volatile uint32_t*)0x380001c4) = 37;
 (*(volatile uint32_t*)0x380001c8) = 38;
 (*(volatile uint32_t*)0x380001cc) = 39;
 (*(volatile uint32_t*)0x380001d0) = 40;
 (*(volatile uint32_t*)0x380001d4) = 41;
 (*(volatile uint32_t*)0x380001d8) = 42;
 (*(volatile uint32_t*)0x380001dc) = 43;
 (*(volatile uint32_t*)0x380001e0) = 44;
 (*(volatile uint32_t*)0x380001e4) = 45;
 (*(volatile uint32_t*)0x380001e8) = 46;
 (*(volatile uint32_t*)0x380001ec) = 47;
 (*(volatile uint32_t*)0x380001f0) = 48;
 (*(volatile uint32_t*)0x380001f4) = 49;
 (*(volatile uint32_t*)0x380001f8) = 50;
 (*(volatile uint32_t*)0x380001fc) = 51;
 (*(volatile uint32_t*)0x38000200) = 52;
 (*(volatile uint32_t*)0x38000204) = 53;
 (*(volatile uint32_t*)0x38000208) = 54;
 (*(volatile uint32_t*)0x3800020c) = 55;
 (*(volatile uint32_t*)0x38000210) = 56;
 (*(volatile uint32_t*)0x38000214) = 57;
 (*(volatile uint32_t*)0x38000218) = 58;
 (*(volatile uint32_t*)0x3800021c) = 59;
 (*(volatile uint32_t*)0x38000220) = 60;
 (*(volatile uint32_t*)0x38000224) = 61;
 (*(volatile uint32_t*)0x38000228) = 62;
 (*(volatile uint32_t*)0x3800022c) = 63;
 (*(volatile uint32_t*)0x38000230) = 0;
 (*(volatile uint32_t*)0x38000234) = 1;
 (*(volatile uint32_t*)0x38000238) = 2;
 (*(volatile uint32_t*)0x3800023c) = 3;
 (*(volatile uint32_t*)0x38000240) = 0;
 (*(volatile uint32_t*)0x38000244) = 1;
 (*(volatile uint32_t*)0x38000248) = 2;
 (*(volatile uint32_t*)0x3800024c) = 3;
 (*(volatile uint32_t*)0x38000250) = 0;
 (*(volatile uint32_t*)0x38000254) = 1;
 (*(volatile uint32_t*)0x38000258) = 2;
 (*(volatile uint32_t*)0x3800025c) = 3;
 (*(volatile uint32_t*)0x38000260) = 0;
 (*(volatile uint32_t*)0x38000264) = 1;
 (*(volatile uint32_t*)0x38000268) = 2;
 (*(volatile uint32_t*)0x3800026c) = 3;
 (*(volatile uint32_t*)0x38000270) = 1;
 (*(volatile uint32_t*)0x38000274) = 2;
 (*(volatile uint32_t*)0x38000278) = 3;
 (*(volatile uint32_t*)0x3800027c) = 4;
 (*(volatile uint32_t*)0x38000280) = 5;
 (*(volatile uint32_t*)0x38000284) = 6;
 (*(volatile uint32_t*)0x38000288) = 7;
 (*(volatile uint32_t*)0x3800028c) = 8;
 (*(volatile uint32_t*)0x38000290) = 9;
 (*(volatile uint32_t*)0x38000294) = 10;
 (*(volatile uint32_t*)0x38000298) = 11;
 (*(volatile uint32_t*)0x3800029c) = 12;
 (*(volatile uint32_t*)0x380002a0) = 13;
 (*(volatile uint32_t*)0x380002a4) = 14;
 (*(volatile uint32_t*)0x380002a8) = 15;
 (*(volatile uint32_t*)0x380002ac) = 16;
 (*(volatile uint32_t*)0x380002b0) = 1;
