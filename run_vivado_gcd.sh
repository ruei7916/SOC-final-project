...
cp ./vvd_caravel_fpga/vvd_caravel_fpga.gen/sources_1/bd/design_1/hw_handoff/design_1.hwh ./jupyter_notebooks_project/caravel_fpga_gcd.hwh

cp ./vvd_caravel_fpga/vvd_caravel_fpga.runs/impl_1/design_1_wrapper.bit ./jupyter_notebooks_project/caravel_fpga_gcd.bit
